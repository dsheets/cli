...
* capability (string - currently `volumedriver`, `networkdriver`, `ipamdriver`, `logdriver`, `metricscollector`, `mountpoint`, or `authz`)
...
`ipamdriver`, `logdriver`, `metricscollector`, `mountpoint`, and `authz` are supported capabilities.
